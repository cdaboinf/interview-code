...
namespace interview_code
{
    public class Arrays
    {
        ...
        */
        ...
        {
            var delimiter = GetIndexOfDelimeter(array);
            var end = array.Length - 1;

            while (delimiter >= 0)
            {
                if (array[delimiter] % 2 == 0)
                {
                    array[--end] = array[delimiter];
                }
        ...
        */
        ...
        /*
            sub-array: sliding window
        */
        public Tuple<int, int> FindLongestSubstringWithUniqueCharacters(string val)
        {
            int s = 0;
            int e = 0;
            int sum = 1;
